...
public class Cyber_DatabaseHelper_Sqlite
     ...
     */
    public Cyber_DatabaseHelper_Sqlite(Context context, String name, SQLiteDatabase.CursorFactory factory,
                                       int version) {
        // 参数说明
        // context：上下文对象
        // name：数据库名称
    ...
    public Cyber_DatabaseHelper_Sqlite(Context context, String name) {
        // 参数说明
        // context：上下文对象
        // name：数据库名称
        // param：一个可选的游标工厂（通常是 Null）
