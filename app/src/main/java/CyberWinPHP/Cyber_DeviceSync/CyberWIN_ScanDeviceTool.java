...
public class CyberWIN_ScanDeviceTool {
    private static final String TAG = CyberWIN_ScanDeviceTool.class.getSimpleName();
        ...
        for (int i = 1; i < 255; i++) {// 创建256个线程分别去ping
            ...
            Runnable run = new Runnable() {
                ...
                public void run() {
                    ...
                    String ping = CyberWIN_ScanDeviceTool.this.mPing + currentIp;
