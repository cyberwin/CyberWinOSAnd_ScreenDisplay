...
public class Cyber_blue_PrintUtils {
    private static final int LINE_BYTE_SIZE = 32;
    private static OutputStream outputStream = null;

    public static void setOutputStream(OutputStream outputStream) {
        Cyber_blue_PrintUtils.outputStream = outputStream;
    }
...
//————————————————
 //   版权声明：本文为CSDN博主「偶是老李头」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
//    原文链接：https://blog.csdn.net/dami_lixm/article/details/94008979
}
